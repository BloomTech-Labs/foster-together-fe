              ...
              {index === 2 ? (
                <>
                  <Step>
                    <p>
                      <span>
                        I try to take good care of all the kids in the
                        house--kids born to the foster family, and kids in
                        foster care--so no one feels left out.
                      </span>{" "}
                      It just so happens that she has nine year old twins, and I
                      have an 11 year old daughter and a 10 year old son:
                      perfect ages to pass along my kids' clothes & books.
                    </p>
                  </Step>
                  <Step>
                    <p>
                      ...
                      thrift store or one of Foster Together's clothing
                      partners.
                    </p>
                  </Step>
                </>
                ...
                <Step>
                  <p>
                    While a well-rounded, delicious, and kid-friendly meal is
                    the most requested support, you are free to get creative!
                    Foster Family Helpers sometimes include a treat like
                    fresh-baked cookies, the kids’ favorite fruit or veggies
                    already sliced for snack time throughout the week, a loaf of
                    fresh bread, breakfast burritos, or a bar of chocolate or
                    tub of gelato as a post-bedtime treat for mom or dad.{" "}
                    <span>
                ...
                <Step>
                  <p>
                    <span>
                      Some Family Helpers prefer picking up takeout over
                      cooking,
                    </span>{" "}
                    and some families think takeout is a treat! One Helper
                    simply doubles her own recipe for her family’s dinner every
                    Thursday. Another Family Helpers picks up{" "}
                    <span>
                      fried chicken and sides at the grocery store, or lasagna
                      at Costco.
                    </span>{" "}
                    Listening to what the family wants and needs will make this
                    an extremely effective gift.
                  </p>
                </Step>
              ) : null}
            </div>
