    ...
    <MainContent>
      <Text>
        <ul>
            ...
            <div>
              ...
              <li>
                <p>
                  ...
                  is add to her burden, so if she's not able to clean them, she
                  is welcome to recycle or toss.
                </p>
              </li>
          ...
          <PageTitle>Tips for Those Who Want to Go Beyond the Meal</PageTitle>
          <p>
          ...
          <div style={{ margin: "50px" }}>
            <li>
              <p>
                ...
                agency or county may require a background check, which can take
                up to three weeks. We are here to help with that process. Email
            ...
            <li>
              <p>
                ...
                request for winter gear with the children’s sizes--explaining
                they are in foster care and giving no additional identifying
            ...
            <li>
              <p>
                ...
                nonprofits to provide additional resources, physical supplies,
                and support to foster families. If a need arises, please let us
                know so that our group can partner with you find and deliver the
                items. Connect@fostertogether.co
              </p>
            </li>
          </div>
        </ul>
